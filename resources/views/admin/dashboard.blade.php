...
<div class="dashboard-wrapper">
    ...
    <nav class="navbar">
        <div class="container nav-content">
            <a href="#" class="logo">
                <img src="{{ asset('assets/images/VH_logo.png') }}" alt="VH" style="height: 32px; width: auto;">
                Vacancy Hunting
            </a>
            <div class="user-menu">
    ...
    <div class="container">
        <div class="grid-container">
            ...
            <!-- Blog Management -->
            @if($isSuperAdmin || (isset($permissions['blog']) && $permissions['blog']))
            <a href="{{ route('admin.blog.dashboard') }}" class="card">
                <div class="card-icon-wrapper">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <p class="card-desc">Manage blog posts and articles.</p>
            </a>
            @endif
